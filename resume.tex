...
\begin{document}
    ...
    \section{Objective}
        ...
        \begin{onecolentry}
            Looking to apply my skills in the areas of \textbf{statistics}, \textbf{machine learning}, and \textbf{mathematics} within an innovative, data-driven environment that supports continuous learning.
        \end{onecolentry}
